        ...
        <v-container id="loginform" fluid fill-height>
            ...
            <v-flex xs12 sm8 md4>
                ...
                <v-card-text>
                    ...
                    v-model="isValid"
                    lazy-validation>
                    <v-text-field prepend-icon="mdi-account" v-model=loginData.username :rules="username_rules" name="login" label="Username" type="text"></v-text-field>
                    <v-text-field prepend-icon="mdi-lock-question" v-model=loginData.password :rules="password_rules" name="password" label="Password" id="password" type="password"></v-text-field>
                    </v-form>
                </v-card-text>
                <v-card-actions>
                    <v-spacer></v-spacer>
